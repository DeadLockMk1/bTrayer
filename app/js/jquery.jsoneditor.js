...
(function( $ ) {
    ...
    function assignType(item, val) {
        ...
        if (isObject(val)) className = 'object expanded';
        else if (isArray(val)) className = 'array expanded';
        else if (isBoolean(val)) className = 'boolean expanded';
        else if (isString(val)) className = 'string expanded';
        else if (isNumber(val)) className = 'number expanded';
