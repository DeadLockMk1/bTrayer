...
class CJuiTabs extends CJuiWidget
{
	 ...
	 */
	public $headerTemplate='<li><a href="{url}" title="{alt}">{title}</a></li>';
	/**
	...
	public function run()
	{
		...
		foreach($this->tabs as $title=>$content)
		{
			...
			{
                                $attributes=array('{title}'=>$title,'{url}'=>'#'.$tabId,'{id}'=>$tabId);
				$attributes['{alt}'] = isset($content['alt']) ? $content['alt'] : '';
				$tabsOut.=strtr($this->headerTemplate,$attributes)."\n";
